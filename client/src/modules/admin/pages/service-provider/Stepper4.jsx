...
const Stepper4 = ({ data, onChange, userData, addressId, entityType, companyName, nextStep, prevStep }) => {
  ...
  const IMAGE_SERVER_URL = "http://localhost:8080/api/v1/service-provider-images";
