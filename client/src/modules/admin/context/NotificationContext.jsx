...
export const NotificationProvider = ({ children }) => {
  ...
  const { data, isLoading, isError } = useGetPermissionRequestsMappingQuery({ filter: "all", adminId: user?.user?._id });
  ...
  useEffect(() => {
    const newSocket = io(import.meta.env.VITE_SOCKET_IO_URL || 'http://localhost:5000');
    setSocket(newSocket);
