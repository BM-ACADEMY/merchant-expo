                            ...
                            <CardContent className="space-y-6 py-8">
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-3">
                                        <Input
                                            ...
                                            className="flex-1 rounded-md border-gray-300 focus:ring-[#e03733] focus:border-[#e03733]"
                                            value={quantity}
                                ...
                                <div className="flex items-center gap-3">
                                    <input
                                        ...
                                        className="h-4 w-4 text-[#e03733] focus:ring-[#e03733] border-gray-300 rounded"
                                    />
                                ...
                                {/* Submit Button */}
                                <Button
                                    className={`${isFormValid ? 'cursor-pointer' : 'cursor-not-allowed'} w-full bg-[#e03733] hover:bg-[#c02c2c] text-white font-medium rounded-md py-3 transition-all duration-200 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed`}
