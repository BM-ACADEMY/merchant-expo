            ...
            <div className="flex gap-6">
                ...
                <div className="w-2/3">
                    <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                        <TabsList className="grid w-full grid-cols-2 bg-white rounded-lg shadow-sm">
                            ...
                            >
                                <Package className="w-5 h-5 text-[#e03733]" /> Product Details
                            </TabsTrigger>
                            <TabsTrigger
                                value="company"
                                className="cursor-pointer"
                            >
                                <Building2 className="w-5 h-5 text-[#e03733]" /> Company Details
                            </TabsTrigger>
                        </TabsList>
                            ...
                            <Card className="mt-4 shadow-lg border-0">
                                <CardHeader>
                                    <CardTitle className="text-2xl font-bold text-gray-800 flex items-center gap-2">
                                        <Package className="w-6 h-6 text-[#e03733]" /> Product Details
                                    </CardTitle>
                                </CardHeader>
                                <CardContent>
                                            ...
                                            shouldDisplayKey(key, value) && (key === 'name' || key === 'description') && (
                                                ...
                                                >
                                                    <div className="flex items-center gap-3 mb-2">
                                                        {key === 'name' && <Package className="w-5 h-5 text-[#e03733]" />}
                                                        {key === 'description' && <Info className="w-5 h-5 text-[#e03733]" />}
                                                ...
                                                shouldDisplayKey(key, value) && key !== 'name' && key !== 'description' && (
                                                    ...
                                                    >
                                                        <div className="flex items-center gap-2 mb-1">
                                                            {key === 'price' && <IndianRupee className="w-4 h-4 text-[#e03733]" />}
                                                            {key === 'category_id' && <Tag className="w-4 h-4 text-[#e03733]" />}
                                                            {key === 'sub_category_id' && <Tag className="w-4 h-4 text-[#e03733]" />}
                        ...
                        <TabsContent value="company" ref={companyRef}>
                            <Card className="mt-4 shadow-lg border-0">
                                <CardHeader>
                                    <CardTitle className="text-2xl font-bold text-gray-800 flex items-center gap-2">
                                        <Building2 className="w-6 h-6 text-[#e03733]" /> Company Details
                                    </CardTitle>
                                </CardHeader>
                                <CardContent>
                                    <div className="space-y-4">
                                        ...
                                        {Object.entries(seller).map(([key, value]) => (
                                            shouldDisplayKey(key, value) && (key === 'company_name' || key === 'description') && (
                                                ...
                                                >
                                                    <div className="flex items-center gap-3 mb-2">
                                                        {key === 'company_name' && <Briefcase className="w-5 h-5 text-[#e03733]" />}
                                                        {key === 'description' && <Info className="w-5 h-5 text-[#e03733]" />}
                                                        <p className="text-sm font-semibold text-gray-700">{formatKey(key)}</p>
                                                    </div>
                                                    <p className={`text-sm text-gray-600 ${key === 'description' ? 'h-fit' : ''}`}>
                                                ...
                                                shouldDisplayKey(key, value) && key !== 'company_name' && key !== 'description' && (
                                                    ...
                                                    >
                                                        <div className="flex-shrink-0">
                                                            {key === 'company_email' && <Mail className="w-5 h-5 text-[#e03733]" />}
                                                            {key === 'company_phone_number' && <Phone className="w-5 h-5 text-[#e03733]" />}
                                                            {key === 'company_type' && <Building className="w-5 h-5 text-[#e03733]" />}
                                                            {key === 'number_of_employees' && <Users className="w-5 h-5 text-[#e03733]" />}
                                                            {key === 'year_of_establishment' && <Calendar className="w-5 h-5 text-[#e03733]" />}
                                                        </div>
                ...
                <div className="w-1/3 flex flex-col gap-6 ">
                    ...
                    <Card className="shadow-lg border-0">
                        <CardHeader>
                            <CardTitle className="text-xl font-bold text-gray-800 flex items-center gap-2">
                                <ShoppingCart className="w-5 h-5 text-[#e03733]" /> Order Details
                            </CardTitle>
                        </CardHeader>
                        <CardContent>
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <Input
                                        id="units"
                                        type="number"
                                        className="mt-1 rounded-md border-gray-200 focus:border-[#e03733] focus:ring-[#e03733]"
                                ...
                                <Button
                                    className="w-full bg-[#e03733] cursor-pointer hover:bg-[#f79494] text-white font-semibold py-2 rounded-md transition-colors"
                                >
                                    Submit
                                </Button>
                            </div>
                    ...
                    <Card className="shadow-lg border-0">
                        <CardHeader>
                            <CardTitle className="text-xl font-bold text-gray-800 flex items-center gap-2">
                                <MapPin className="w-5 h-5 text-[#e03733]" /> Seller Details
                            </CardTitle>
                        </CardHeader>
                        <CardContent>
                            <div className="space-y-3">
                                {user?.name && (
                                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
                                        <User className="w-5 h-5 text-[#e03733]" />
                                        <div>
                                ...
                                {seller?.company_name || seller?.travels_name && (
                                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
                                        <Briefcase className="w-5 h-5 text-[#e03733]" />
                                        <div>
                                ...
                                {address && getFullAddress(address) && (
                                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
                                        <MapPin className="w-5 h-5 text-[#e03733]" />
                                        <div>
