            ...
            <div className="border shadow space-y-5 p-5 flex flex-col md:flex-row-reverse gap-4">
              ...
              <div className="relative group w-full md:w-1/4 flex justify-center items-center h-auto rounded overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center p-4">
                  <h2 className="text-white text-lg max-w-fit md:text-sm font-bold text-center bg-black/70  py-1 rounded transition-transform duration-500 group-hover:scale-105">
                ...
                {category?.subCategories?.slice(0, 4).map((sub, subIdx) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <Link to={`/subcategory/${sub.subCategoryId}`}>
                        <h3 className="mt-2 font-semibold text-sm mb-2 text-[#e03733] hover:underline">
                          {sub.subCategoryName}
                        </h3>
                      </Link>
                      <ul className="list-disc list-inside text-xs text-gray-600">
                        {sub?.superSubCategories?.map((item, itemIdx) => (
                          <li key={item.superSubCategoryId}>
                            <Link
                              to={`/supersubcategory/${item.superSubCategoryId}`}
