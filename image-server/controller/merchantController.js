...
const uploadImages = async (req, res) => {
    try {
      ...
      for (let file of req.files) {
        ...
        const fileUrl = await processFile(file.buffer, file.mimetype, entity_type, company_name, fileName);
...
const uploadCompanyLogo = async (req, res) => {
    try {
      ...
      // ✅ Pass correct arguments to processFile()
      const logoUrl = await processFile(req.file.buffer, req.file.mimetype, "merchant", "logo", fileName);
